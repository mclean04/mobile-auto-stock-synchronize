    ...
    @Test fun typedReportBindsIntentVersionEnvironmentAccountAndPreflight() {
        val intentJson = JSONObject().put("contract_version", "2.0")
            ...
            .put("cash_requirements", JSONObject().put("currency", "VND")
                .put("principal_vnd", "12000000").put("fee_reserve_vnd", "24000")
                .put("required_cash_vnd", "12024000").put("fee_reserve_rate", "0.002")
        ...
        val preflightJson = JSONObject().put("contract_version", "2.0")
            ...
            .put("source_context", JSONObject(intentJson.getJSONObject("source_context").toString()))
            .put("cash_requirements", JSONObject(intentJson.getJSONObject("cash_requirements").toString()))
            .put("eligibility", JSONObject().put("eligible", true).put("reasons", JSONArray()))
        ...
        assertEquals(7, payload.getJSONObject("source_context").getInt("source_generation"))
